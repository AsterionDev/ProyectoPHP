...
<body class="container">
    <div class="d-flex justify-content-center flex-column  m-5">
        ...
        <button type="button" class="btn btn-dark mb-4" data-toggle="modal" data-target="#usuarioModal">
            Agregar usuario
        </button>
                    ...
                    while ($fila = mysqli_fetch_array($resultado)) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="editar_usuario.php?id=<?php echo $fila['Id_U'] ?>" class="btn btn-primary">Editar</a>
                                <a href="eliminar_usuario.php?id=<?php echo $fila['Id_U'] ?>" class="btn btn-danger">Eliminar</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
